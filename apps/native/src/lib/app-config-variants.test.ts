...
describe("app variants", () => {
  it.each([
    ...
    },
    {
      ...
      iosIcon: "./assets/images/ConPaws-preview.icon",
      foreground: "./assets/images/android-icon-foreground-preview.png",
      monochrome: "./assets/images/android-icon-monochrome-preview.png",
    },
    {
