...
import { SafeView, Text, Button, Separator } from '@/components/ui';
    ...
    <SafeView>
      <View className="flex-1 items-center justify-center px-6 gap-6">
        ...
        <View className="w-full gap-3">
          <Button variant="default" size="lg" onPress={() => {}} className="w-full">
            {t('onboarding.getStarted.signInWithApple')}
          </Button>
          <Button variant="outline" size="lg" onPress={() => {}} className="w-full">
